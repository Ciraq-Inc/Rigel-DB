<template>
  <div class="container-fluid">
    <div class="parent">
      <div class="div1 card__outer">
        <div class="m-2">
        <div class="d-flex justify-content-between">
          <h4>Rigelis: <span class="text-primary"><strong>V-3.5</strong></span></h4>
          <SearchForm2 />
        </div>
          <div class="row mt-2">
            <div class="col-lg-4">
                  ...
                  <div class="widget-49">
                    <div class="widget-49-title-wrapper">
                      ...
                      <div class="widget-49-meeting-info">
                        <span class="widget-49-pro-title">Arzthena</span>
                ...
                <div class="card-body pt-0">
                  <div class="widget-49">
                    <div class="widget-49-title-wrapper">
                      ...
                      <div class="widget-49-meeting-info">
                        <span class="widget-49-pro-title">New Discovery</span>
                        <span class="widget-49-meeting-time">12:00 to 13.30 Hrs</span>
                      </div>
                    </div>
                    <ol class="widget-49-meeting-points">
                ...
                <div class="card-body pt-0">
                  <div class="widget-49">
                    <div class="widget-49-title-wrapper">
                      ...
                      <div class="widget-49-meeting-info">
                        <span class="widget-49-pro-title">Navia Pharmacy</span>
                        <span class="widget-49-meeting-time">12:00 to 13.30 Hrs</span>
                      </div>
                    </div>
                    <ol class="widget-49-meeting-points">
